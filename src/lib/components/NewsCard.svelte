<script lang="ts">
	...
	import g from '$lib/assets/g.png';
	export let news = {
		title: '',
...
<div
	...
	class="card card-compact max-w-xs md:w-[384px] max-h-64 md:max-h-80 shadow-xl md:hover:-translate-y-2 transition-[.5s] cursor-pointer"
	on:click={(ev) => {
		goto('#');
	}}
	tabindex="0"
>
	...
	<div class="card-body bg-primary-content ">
		...
		<div class="card-actions justify-end">
			<div class="md:text-sm">{formatMyDate(news.date)}</div>
		</div>
	</div>
</div>
